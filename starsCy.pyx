...
class Circle(Dot):
    def __init__(self, kind, pos, color):
        ...
        cdef list radii, colors, dym_color, chromes_step
        cdef int radii_len, static_i
        cdef float timer, time
        #cdef tuple color
...
cdef object dotObj, star
cdef str kind
cdef int x, y, time
cdef list radii
cpdef object fix(object bg_obj, list stars):
    cdef list colors
